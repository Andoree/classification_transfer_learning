...
def main():
    ...
    parser.add_argument('--input_files', nargs='+', default=[r"../../data/en_tweets_w_smiles/train.tsv",
                                                             r"../../data/ru_tweets_w_smiles/train.tsv"])
    parser.add_argument('--output_path', default=r"../../data/ruen_tweets_w_smiles/train.tsv")
