...
def get_drugbank_list(drugbank_df, drug_name_column, selected_terms_column, active_compound_column):
    drugbank_list = []
...
def get_tweet_drug_from_list(tweet_text, drugs_list):
...
def main():
    ...
    parser.add_argument('--not_matched_path', default=r"../../data/not_matched/not_matched_ru_test.tsv")
