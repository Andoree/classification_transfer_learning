...
def main():
    ...
    text_tokenizer = BertTokenizer(f"{model_dir}/tokenizer_config.json", do_lower_case=False)
    ...
    if model_type == "ru_nodrug":
        enrudr_model = AutoModel.from_pretrained(model_dir,)
